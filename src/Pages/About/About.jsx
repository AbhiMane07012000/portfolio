...
const About = () => {
  ...
  return (
    <section  id="about" className="flex flex-col lg:flex-row lg:h-[100vh] py-10">
      <div className="flex flex-col justify-center   py-10 lg:px-7 w-5/6 md:w-4/5  lg:w-1/2 text-left md:text-left lg:h-full ">
        ...
        <p className="pl-10 lg:pl-16 md:pl-16 text-left font-medium text-sm pb-5  md:text-lg">
          Throughout , I've acquired knowledge in several technologies,
          including Cloud Computing, Database Technologies, Web Frameworks,
          Advanced Operating System, Mobile Technologies (Android), Software
          Architecture & Design Patterns, Machine Learning and Software Project
          Management.
        </p>
        <p className=" pl-10 lg:pl-16 md:pl-16 text-left font-medium text-sm pb-5  md:text-lg">
          I've also explored frameworks like Node.js, React and Bootstrap and
          Tailwind CSS, all in a short period with a strong understanding of
          these concepts.
        </p>
        <button className="ml-10 md:ml-14 lg:ml-16 w-1/2 md:w-1/4 lg:w-1/4  mb-5 bg-black py-2  rounded-3xl flex flex-row justify-center">
          <svg
