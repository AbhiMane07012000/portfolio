  ...
  return (
    <section id='about' className='flex flex-col lg:flex-row lg:h-[100vh]'>
      <div className="flex flex-col justify-center   py-10 lg:px-7 w-5/6 md:w-4/5  lg:w-1/2 text-left md:text-left lg:h-full ">
        <h2 className=" pl-10 lg:pl-16 md:pl-16 text-left text-xl font-extrabold pb-7 md:text-3xl font-code ">function About(me)  </h2>
      ...
      >
        <img
          ref={ImageRef}
          className=" lg:m-10 self-center md:grayscale transition duration-500 ease-in-out transform  hover:scale-95 hover:rotate-3 hover:grayscale-0 w-2/5  shadow-lg shadow-black rounded-md "
          src="./Photo.jpg"
          alt="My-image"
        />
