  ...
  return (
    <>
      <section
        ...
        id="home"
        className="lg:hidden flex flex-col-reverse lg:flex-row lg:h-[100vh] py-10 md:py-10"
      >
        <div className=" flex h-full lg:w-1/2  items-center justify-center lg:h-full py-10 lg:py-0">
          {/* <img
        ...
        <div className="lg:w-1/2 pl-10 py-10 lg:py-32 lg:h-full">
          ...
          <div className="pl-4 flex flex-row space-x-6">
            ...
            <a  href="">
              <FaLinkedinIn
                className="hover:animate-bounce  size-6 md:size-7"
      ...
      <section className='hidden lg:block h-[100vh]'>
